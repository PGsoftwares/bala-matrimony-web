                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea rows="4" type="text" id="description" name="description" placeholder="Description" class="form-control"></textarea>
                                                </div>
                                                <div class="form-group mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea name="content" id="blog" class="form-control"></textarea>
                                                </div>
                                                <div class="text-end">
