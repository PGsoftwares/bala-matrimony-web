...
<head>
    ...
    <title>Broker Alert - Profile views</title>
</head>
            ...
            <table width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); overflow: hidden;">
                ...
                <tr>
                    <td style="background-color: #f07525; padding: 20px; text-align: center; color: #ffffff;">
                        <h1 style="margin: 0; font-size: 24px;">Broker Alert - Profiles</h1>
                    </td>
                </tr>
                <!-- Body Section -->
                <tr>
                    <td style="padding: 20px; text-align: left;">
                        <p style="font-size: 16px; margin: 0 0 10px;">
                            The user <strong style="color: #f07525;">{{ $user->name }}</strong> has viewed profiles in {{ $viewedCount }} times.
                        </p>
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                            ...
                            <tr>
                                <td style="padding: 10px; font-weight: bold;">No of Profile viewed</td>
                                <td style="padding: 10px;">{{ $viewedCount }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
