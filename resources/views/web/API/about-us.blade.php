...
@section('title', $metaTags->title ?? 'About Us')
...
@section('content')
    ...
    {{-- Banner Section--}}
    <section id="page-title" class="page-title-center text-light" style="background-image:url({{ asset('web/assets/images/slider/breadcrumb-banner.jpg') }});background-repeat: no-repeat; background-size: cover;"  >
