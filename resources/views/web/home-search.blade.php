...
@section('content')
    ...
    <section class="container-fluid bg-light-primary">
        <div class="row">
            ...
            @include('web.includes.home-aside-search')
            ...
            <div class="col-md-8 mt-md-4 mb-5 shadow-sm bg-white rounded-4">
                <div class="d-flex justify-content-between  py-3 px-2 align-items-center ">
                    <h5 class="fw-medium">Search Matches</h5>
                    ...
                    <div class="card mb-3 shadow-sm rounded-3 p-3">
                        <div class="row align-items-start">
                            ...
                            <div class="col-md-4 text-center">
                                @if(auth()->check())
                                    @php
                                        $imagePath = public_path('Profile Image/' . $profile->profile_image);
                                    @endphp
                                    @if($profile->profile_image && file_exists($imagePath))
                                        <img class="img-fluid rounded" src="{{ asset('Profile Image/' . $profile->profile_image) }}" alt="" >
                                    @else
                                        <img class="img-fluid rounded" src="{{ asset('web/assets/default/default.png') }}" alt="">
                                    @endif
                                @else
                                    <i class="fa fa-lock" style="max-width: 100%;font-size: 100px; height: 200px; display: flex;justify-content: center;align-items: center"></i>
                                @endif
                            </div>
